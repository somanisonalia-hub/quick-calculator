    ...
    <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm border border-gray-200">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
        ...
        <div className="space-y-2 sm:space-y-3">
          ...
          {inputs.map((input) => (
            <div key={input.name} className="space-y-1 sm:space-y-2">
              ...
              <input
                ...
                max={input.max}
                step={input.step}
                className="w-full px-2.5 py-2 sm:px-3 sm:py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
              />
            </div>
          ))}
          ...
          <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2">
            <button
              onClick={calculate}
              className="flex-1 bg-blue-600 text-white py-2.5 px-3 sm:py-2.5 sm:px-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-sm font-semibold transition-colors duration-200"
            >
              {t.calculate}
            </button>
            <button
              onClick={resetCalculator}
              className="flex-1 bg-gray-200 text-gray-800 py-2.5 px-3 sm:py-2.5 sm:px-4 rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 text-sm font-semibold transition-colors duration-200"
            >
              {t.reset}
            </button>
          </div>
        ...
        <div className="space-y-2 sm:space-y-3">
          ...
          {additionalOutputs.map((additionalOutput) => (
            <div key={additionalOutput.field} className="bg-white border border-gray-200 p-2.5 sm:p-3 rounded-md shadow-sm">
