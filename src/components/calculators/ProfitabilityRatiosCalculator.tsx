...
export default function ProfitabilityRatiosCalculator({ lang = 'en' }: ProfitabilityRatiosCalculatorProps) {
  ...
  const translations = {
    ...
    de: {
      title: "Rentabilitätskennzahlen-Rechner",
      description: "Analysieren Sie Unternehmensrentabilität mit wichtigen Finanzquoten",
      revenueInput: "Umsatz",
      costOfGoodsInput: "Kosten der verkauften Waren",
      operatingExpensesInput: "Betriebsausgaben",
      taxExpensesInput: "Steuerausgaben",
      totalAssetsInput: "Gesamtvermögen",
      equityInput: "Eigenkapital",
      calculate: "Berechnen",
      results: "Rentabilitätsergebnisse",
      grossProfit: "Bruttogewinn",
      operatingIncome: "Betriebseinkommen",
      netIncome: "Nettoeinkommen",
      netIncomeAfterTax: "Nettoeinkommen nach Steuern",
      grossProfitMargin: "Bruttogewinnmarge",
      operatingProfitMargin: "Betriebsgewinnmarge",
      netProfitMargin: "Nettogewinnmarge",
      returnOnAssets: "Rendite auf Vermögenswerte (ROA)",
      returnOnEquity: "Rendite auf Eigenkapital (ROE)",
      interpretation: "Kennzahlinterpretation",
      currency: "€",
      grossMarginStrong: "Bruttogewinn > 30%: Hohe Rentabilität",
      netMarginGood: "Nettogewinn > 10%: Gute Endergebnis-Leistung",
      roaEffective: "ROA > 6%: Effektive Vermögensnutzung",
      roeExcellent: "ROE > 15%: Hervorragende Renditen für Aktionäre"
    },
    nl: {
      title: "Winstgevingsratio's Rekenmachine",
      description: "Analyseer bedrijfswinstgeving met sleutelfinanciële ratio's",
      revenueInput: "Opbrengst",
      costOfGoodsInput: "Kosten van Verkochte Goederen",
      operatingExpensesInput: "Bedrijfskosten",
      taxExpensesInput: "Belastinguitgaven",
      totalAssetsInput: "Totale Activa",
      equityInput: "Eigen Vermogen",
      calculate: "Berekenen",
      results: "Winstgevingsresultaten",
      grossProfit: "Brutowinst",
      operatingIncome: "Bedrijfsopbrengsten",
      netIncome: "Nettowinst",
      netIncomeAfterTax: "Nettowinst na Belasting",
